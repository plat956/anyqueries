...
import by.latushko.anyqueries.validator.impl.RepeatActivationValidator;
...
public class RepeatActivationCommand implements Command {
    ...
    public CommandResult execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        FormValidator validator = RepeatActivationValidator.getInstance();
        ...
        //todo change user email, telegram, send link if it needs
        boolean result = true;
