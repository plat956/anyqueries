...
public final class AppProperty {
    ...
    private static final String APP_AUTHORIZATION_COOKIE_ALIVE_DAYS_PARAMETER = "app.authorization.cookie.alive";
    public static final String APP_HOST;
    public static final Integer APP_ACTIVATION_LINK_ALIVE_HOURS;
    public static final Integer APP_AUTHORIZATION_COOKIE_ALIVE_DAYS;
    ...
    static {
        ...
        try {
            ...
            APP_AUTHORIZATION_COOKIE_ALIVE_DAYS = Integer.valueOf(properties.getProperty(APP_AUTHORIZATION_COOKIE_ALIVE_DAYS_PARAMETER));
        } catch (IOException e) {
